...
export default {
    template: `
        <div class="page-container" :class="{ dark: store.dark }" style="padding: 2rem 1.5rem; width: 100%; max-width: 900px; margin: 0 auto; min-height: 85vh; box-sizing: border-box;">
            <!-- Header Bar -->
            ...
            <!-- Empty State -->
            <div v-else-if="submissions.length === 0" style="text-align: center; padding: 4rem 1.5rem; background: rgba(128,128,128,0.08); border: 1px solid rgba(128,128,128,0.15); border-radius: 14px;">
            ...
            <div v-else style="display: flex; flex-direction: column; gap: 1.25rem;">
                <div 
                    ...
                    :key="sub.id" 
                    style="background: rgba(128,128,128,0.08); border: 1px solid rgba(128,128,128,0.18); border-radius: 14px; padding: 1.5rem; display: flex; flex-direction: column; gap: 1rem; box-shadow: 0 4px 16px rgba(0,0,0,0.1);"
                >
                    <!-- Card Top Row -->
